...
ALTER TABLE "cidade"
  ADD FOREIGN KEY ("estado_id") REFERENCES "public"."estado" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "endereco"
  ADD FOREIGN KEY ("cidade_id") REFERENCES "cidade" ("id") ON DELETE CASCADE ON UPDATE CASCADE;